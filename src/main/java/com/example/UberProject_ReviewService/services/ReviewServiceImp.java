package com.example.UberProject_ReviewService.services;


import com.example.UberProject_ReviewService.Repositories.ReviewRepository;
...
public class ReviewServiceImp implements ReviewService{
    ...
    public Optional<Review> findReviewById(Long id) throws EntityNotFoundException {
        ...
        try{
            ...
            throw new FetchNotFoundException("Unable to fetch please try after some time",id);
